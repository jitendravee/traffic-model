...
VIDEO_FEEDS = [
    "/media/jitendra/sandisk_1/python/traffic-ai/test_images/1.jpg",
    "/media/jitendra/sandisk_1/python/traffic-ai/test_images/2.jpg",
    "/media/jitendra/sandisk_1/python/traffic-ai/test_images/3.jpg",
]

# Load YOLO model
net = cv2.dnn.readNet("/media/jitendra/sandisk_1/python/traffic-ai/bin/yolov3.weights", "/media/jitendra/sandisk_1/python/traffic-ai/cfg/yolov3.cfg")
layer_names = net.getLayerNames()
out_layers = [layer_names[i - 1] for i in net.getUnconnectedOutLayers().flatten()]


# Load COCO class labels
with open("/media/jitendra/sandisk_1/python/traffic-ai/cfg/coco.names", "r") as f:
